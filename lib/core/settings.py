...
PHP_ALIASES = ("php", "php5", "php7")
PYTHON_ALIASES = ("python", "python27","python3")
SHELL_ALIASES = ("shell", "bash","sh")
...
GITHUB_REPORT_OAUTH_TOKEN = "We don't want to spam SQLMap. Do we?"
