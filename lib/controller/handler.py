...
from plugins.dbms.php import PHPMap
from plugins.dbms.python import PYTHONMap
from plugins.dbms.shell import SHELLMap
...
def setHandler():
    ...
    items = [
        ...
        (DBMS.PHP, PHP_ALIASES, PHPMap, MySQLConn),
        (DBMS.PYTHON, PYTHON_ALIASES, PYTHONMap, MySQLConn),
        (DBMS.SHELL, SHELL_ALIASES, SHELLMap, MySQLConn),
